...
Output_dir = '/Users/fei/WSP/Scie/CosmPS/Data/ProdFt/'
...
for i_mock in range(Nmock):
    ...
    if(Nrand >1):    
        ...
        nbRmk      = infiler[3] 
        ndataRmk   = len(raR)   
        var,var = FormatData_Fun([raR,decR,czR,    nbRmk*ndata_mk/ndataRmk ,      FKP], Output_dir+'MockRand_'+str(i_mock), 'gal-rand')   
...
print('velocity mocks: Nrand/Ndata=',np.mean(ndatavR/np.array(ndatamk)))    
