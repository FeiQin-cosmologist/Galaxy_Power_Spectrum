...
def PSloop_Fun( KmodLim,hub,ombh2,omch2,ns, As,out_dir ):  
    #Linear spectra
...
def PkmodMulti_Fun(params,OnlyL0,Sig8_fid, k_obs, kmod_conv,WF_Kobs_Kmod,WF_rand,PT,ps_type, Growthz, WFCon_type):
    if((WFCon_type!='Ross')and(WFCon_type!='Blake')and(WFCon_type!='Beutler')):
        ...
        WFCon_type ='Blake'
    Pk_mods , psty= Pkmod_Fun(params,Sig8_fid,PT,ps_type, Growthz )
