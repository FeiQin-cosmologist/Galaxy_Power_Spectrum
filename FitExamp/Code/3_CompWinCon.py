...
covden,ki,kjo=np.load(file_dir+'convden_CosmPS_' +PS_measure+'.npy',allow_pickle=True) 
covmom,ki,kjo=np.load(file_dir+'convmom_CosmPS_' +PS_measure+'.npy',allow_pickle=True) 
covcrs,ki,kjo=np.load(file_dir+'convcrs_CosmPS_' +PS_measure+'.npy',allow_pickle=True)
covCosmPS=[covden,covmom,covcrs]
Nkmod=len(kjo) 
Nkdat=len(ki)

covden,kip,kjp=np.load(file_dir+'convden_Pypower_' +PS_measure+'.npy',allow_pickle=True) 
covmom,kip,kjp=np.load(file_dir+'convmom_Pypower_' +PS_measure+'.npy',allow_pickle=True) 
covcrs,kip,kjp=np.load(file_dir+'convcrs_Pypower_' +PS_measure+'.npy',allow_pickle=True)
...
Pkmodc_denb ,kmodc_denb ,Pkmod_denb ,kmod_denb =PkmodMulti_Fun(parm,False, Sig8_fid, ki , kjb,  covCosmPS   , np.nan , PT, 'den-024', az,Hz,Dz, 'CosmPS' )
Pkmodc_denp ,kmodc_denp ,Pkmod_denp ,kmod_denp =PkmodMulti_Fun(parm,False, Sig8_fid, kip, kjp,  covpypw    , np.nan , PT, 'den-024', az,Hz,Dz, 'Pypower' )
# 3.5 momentum power:----------------
...
Pkmodc_momb ,kmodc_momb ,Pkmod_momb ,kmod_momb =PkmodMulti_Fun(parm,False, Sig8_fid, ki , kjb,  covCosmPS   , np.nan , PT, 'mom-024', az,Hz,Dz, 'CosmPS' )
Pkmodc_momp ,kmodc_momp ,Pkmod_momp ,kmod_momp =PkmodMulti_Fun(parm,False, Sig8_fid, kip, kjp,  covpypw    , np.nan , PT, 'mom-024', az,Hz,Dz, 'Pypower' )
# 3.6 cross    power:----------------
Pkmodc_crsb ,kmodc_crsb ,Pkmod_crsb ,kmod_crsb =PkmodMulti_Fun(parm,False, Sig8_fid, ki , kjb,  covCosmPS   , np.nan , PT, 'crsv-13' , az,Hz,Dz, 'CosmPS' )
Pkmodc_crsp ,kmodc_crsp ,Pkmod_crsp ,kmod_crsp =PkmodMulti_Fun(parm,False, Sig8_fid, kip, kjp,  covpypw    , np.nan , PT, 'crsv-13' , az,Hz,Dz, 'Pypower' )
...
# crs ps:
Pkmodc_crs0,kmodc_crs0,Pkmod_crs,kmod_crs =PkmodMulti_Fun(parm,False, Sig8_fid, kbin, np.nan,np.nan,np.nan, PT, 'crsv-13' , az,Hz,Dz, np.nan) 
...
plt.plot(kmodc_denb[0*Nkdat:1*Nkdat] ,kmodc_denb[0*Nkdat:1*Nkdat]* Pkmodc_denb[0*Nkdat:1*Nkdat] ,c='orangered' ,  label='Conv PS CosmPS')
...
plt.plot(kmodc_denb[1*Nkdat:2*Nkdat] ,kmodc_denb[1*Nkdat:2*Nkdat]* Pkmodc_denb[1*Nkdat:2*Nkdat] ,c='orangered' ,label='Conv PS CosmPS')
...
plt.plot(kmodc_denb[2*Nkdat:3*Nkdat] ,kmodc_denb[2*Nkdat:3*Nkdat]* Pkmodc_denb[2*Nkdat:3*Nkdat] ,c='orangered' ,label='Conv PS CosmPS')
...
plt.plot(kmodc_momb[0*Nkdat:1*Nkdat] , Pkmodc_momb[0*Nkdat:1*Nkdat] ,c='orangered' ,label='Conv PS CosmPS')
...
plt.plot(kmodc_momb[1*Nkdat:2*Nkdat] , Pkmodc_momb[1*Nkdat:2*Nkdat] ,c='orangered' ,label='Conv PS CosmPS')
...
plt.plot(kmodc_momb[2*Nkdat:3*Nkdat] , Pkmodc_momb[2*Nkdat:3*Nkdat] ,c='orangered' ,label='Conv PS CosmPS')
...
plt.plot(kmodc_crsb[0*Nkdat:1*Nkdat] ,kmodc_crsb[0*Nkdat:1*Nkdat]* Pkmodc_crsb[0*Nkdat:1*Nkdat] ,c='orangered' ,label='Conv PS CosmPS')
...
plt.plot(kmodc_crsb[1*Nkdat:2*Nkdat] ,kmodc_crsb[1*Nkdat:2*Nkdat]* Pkmodc_crsb[1*Nkdat:2*Nkdat] ,c='orangered' ,label='Conv PS CosmPS')
